        console.log('StockSim initializing...');
        ...
        async function loadPortfolioTab() {
            ...
            const baseline = tutorialCompleted ? 100000 : 0;
            const totalGainLoss = totalValue - baseline;
            const totalGainLossPercent = baseline > 0 ? ((totalValue - baseline) / baseline * 100).toFixed(2) : "0.00";
